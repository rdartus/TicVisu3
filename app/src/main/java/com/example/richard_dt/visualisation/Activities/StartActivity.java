...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref p =  new pref(this.getApplicationContext());
//        p.setString("urlApi", "http://192.168.43.70:3000/api/");
                    ...
                    if (R.getClassroom_list().contains(Double.valueOf((String) Clist.get(0).get(k)))) {
                        ...
                        ArrayList arrayListClassroomErrorCount = Clist.get(1);
                            if(regionArrayArrayList.size()!=0) {
                                ...
                                ArrayList al2 = new ArrayList();
                                al1.add(Rid);
                                al2.add(arrayListClassroomErrorCount.get(k));
                                regionArrayArrayList.add(al1);
                                regionArrayArrayList.add(al2);
                            }

                        Rlist= regionArrayArrayList;
                    }
                }
            }
        }

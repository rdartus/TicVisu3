 ...
 */
public class Classroom implements Parcelable, Comparable<Classroom>{
    ...
    public int compareTo(Classroom another) {
        if (region_id == another.region_id
                && classroom_name.compareTo(another.classroom_name)==0
                && classroom_id == another.classroom_id){

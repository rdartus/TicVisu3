...
public class StaffFragment extends Fragment implements WeekView.EventClickListener,WeekView.EventLongPressListener,MonthLoader.MonthChangeListener,WeekView.EmptyViewLongPressListener, View.OnClickListener{
    ...
    Button bNextWeek, bPreviousWeek, bToday, bCalendarLength;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bNextWeek = (Button) rootView.findViewById(R.id.btNextWeek2);
        bPreviousWeek = (Button) rootView.findViewById(R.id.btPreviousWeek2);
        bToday = (Button) rootView.findViewById(R.id.btGoTo2);
        bCalendarLength = (Button) rootView.findViewById(R.id.dateLength2);
